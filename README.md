...
| 同步时间 | 版本标签 | 触发方式 | 状态 |
|----------|----------|----------|------|
| 2026-03-22 04:11:11 | v19 | 自动执行 | ✅ |
| 2026-03-21 03:56:45 | v18 | 自动执行 | ✅ |
| 2026-03-20 04:05:35 | v17 | 自动执行 | ✅ |
| 2026-03-19 04:13:30 | v16 | 自动执行 | ✅ |
| 2026-03-18 04:14:46 | v15 | 自动执行 | ✅ |
| 2026-03-17 04:08:56 | v14 | 自动执行 | ✅ |
| 2026-03-16 04:32:15 | v13 | 自动执行 | ✅ |
| 2026-03-15 04:25:14 | v12 | 自动执行 | ✅ |
| 2026-03-14 04:02:27 | v11 | 自动执行 | ✅ |
| 2026-03-13 04:03:51 | v10 | 自动执行 | ✅ |
...
docker run --name new-api -d --restart always \
  ...
  -e TZ=Asia/Shanghai \
  -v /home/ubuntu/data/new-api:/data \
  ghcr.io/bqizkm01918t/openai-new:v19
```
...
- **最后同步时间**: 2026-03-22 04:11:16 UTC
- **当前版本标签**: v19
- **同步触发方式**: 自动执行
- **同步状态**: ✅ 成功
...
*此 README 由 GitHub Actions 自动更新于 2026-03-22 04:11:16 UTC*
