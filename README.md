...
- **当前版本标签**: 20251101081205

## 📅 同步记录

| 同步时间 | 触发方式 | 版本标签 | 状态 |
|----------|----------|----------|------|
| 2025-11-01 08:12:08 UTC | 手动触发 | 20251101081205 | ✅ 成功 |
...
```bash
# 使用特定版本（推荐）
docker run --name new-api -d --restart always -p 3000:3000 -e TZ=Asia/Shanghai -v /home/ubuntu/data/new-api:/data ghcr.io/bqizkm01918t/openai-new:20251101081205
```
