...
| 同步时间 | 版本标签 | 触发方式 | 状态 |
|----------|----------|----------|------|
| 2026-03-03 04:05:58 | v2 | 自动执行 | ✅ |
| 2026-03-02 04:05:17 | v1 | 自动执行 | ✅ |
| 2026-03-01 04:13:41 | v0 | 自动执行 | ✅ |
| 2026-02-28 03:46:32 | v19 | 自动执行 | ✅ |
| 2026-02-27 04:04:11 | v18 | 自动执行 | ✅ |
| 2026-02-26 04:07:39 | v17 | 自动执行 | ✅ |
| 2026-02-25 04:11:05 | v16 | 自动执行 | ✅ |
| 2026-02-24 04:09:25 | v15 | 自动执行 | ✅ |
| 2026-02-23 04:13:56 | v14 | 自动执行 | ✅ |
| 2026-02-22 04:08:09 | v13 | 自动执行 | ✅ |
...
docker run --name new-api -d --restart always \
  ...
  -e TZ=Asia/Shanghai \
  -v /home/ubuntu/data/new-api:/data \
  ghcr.io/bqizkm01918t/openai-new:v2
```
...
- **最后同步时间**: 2026-03-03 04:06:08 UTC
- **当前版本标签**: v2
- **同步触发方式**: 自动执行
- **同步状态**: ✅ 成功
...
*此 README 由 GitHub Actions 自动更新于 2026-03-03 04:06:08 UTC*
